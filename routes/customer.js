...
const { getNewProducts, getFeaturedProducts, getProductForListing, getProduct } = require("../handlers/product-handle");
const { getCategories } = require("../handlers/category-handle");
const { getBrands } = require("../handlers/brand-handle");
const { getWishlist, addToWishlist, removeFromWishlist } = require("./../handlers/wishlist-handle");
const { getCart, getCartItems, addToCart, removeFromCart, clearCart } = require("../handlers/shopping-cart-handle");
const { addOrder, getCustomerOrders } = require("../handlers/order-handle");
